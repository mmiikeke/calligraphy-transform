...
if __name__ == '__main__':
    ...
    data_6d = calligraphy_tool.transform_6d(data_6d, z0_point, anchor=0, ratio=[1, 1, 0.6], translate=[0, 0, -4], angle=0)

    data_6d = calligraphy_tool.transform_to_rect_6d(data_6d, [-183.5, -127.0, 405, 443.5], z0_point, ratio_z=0, translate_z=0, center=True, deform=False)
