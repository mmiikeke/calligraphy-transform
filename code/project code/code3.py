...
if __name__ == '__main__':
    path = '../../data/source/3/char00423_stroke_1_15.txt'
    output_path = '../../data/source/3/word.txt'
    ...
    data_6d = calligraphy_tool.transform_6d(data_6d, z0_point, anchor=0, ratio=[0.75, 1, 0.6], translate=[0, 0, 0], angle=0)

    data_6d = calligraphy_tool.transform_to_rect_6d(data_6d, [-60.5, -4, 405, 443.5], z0_point, ratio_z=0, translate_z=0, center=True, deform=False)
