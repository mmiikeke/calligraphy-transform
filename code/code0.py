...
if __name__ == '__main__':
    ...
    data_6d_1 = calligraphy_tool.transform_6d(data_6d_1, z0_point, anchor=0, ratio=[1, 1, 0.6], translate=[0, 0, 0], angle=0)
    
    data_6d_2, data_cmd_2 = calligraphy_tool.read_file(path2, is_6dcmd=True)
    data_6d_2 = calligraphy_tool.transform_6d(data_6d_2, z0_point, anchor=0, ratio=[0.7, 0.85, 0.6], translate=[6, 2, -2], angle=2)

    data_6d_3, data_cmd_3 = calligraphy_tool.data_6d_cmd_concate(data_6d_1, data_6d_2, data_cmd_1, data_cmd_2)
